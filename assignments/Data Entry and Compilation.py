...
class DataRecordForm(tk.Frame):
    def __init__(self, parent, *args, **kwargs):
        ...
        self.inputs['Temperature'] = LabelInput(
            environmentinfo, "Temperature (Degrees C)",    
            input_class=tk.Spinbox,
            input_var=tk.DoubleVar(),
...
class Application(tk.Tk):
    def __init__(self, *args, **kwargs):
        ...
        self.title("CSIRO Data Entry Application")
        self.resizable(width=False, height=False)
        
        ttk.Label(
            self,
            text="CSIRO Data Entry Application",
        ...
        self.status.grid(sticky=tk.E + tk.W, row=3, padx=5)

        self.records_saved = 0

    def on_save(self):
        datestring = datetime.today().strftime("%Y-%m-%d")
        filename = "csiro_data_record_{}.csv".format(datestring)
        ...
        self.status.configure(text="{} records saved during this session".format(self.records_saved))
